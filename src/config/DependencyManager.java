...
public class DependencyManager {
	...
	// Controller의 경우 맨 처음에는 각 Panel들이 Controller들의 클래스를 가지고 있었고 각 Controller등의 초기화를 담당했으나
	// MainFrame의 모든 지역 변수들이 초기화된 이후에 Controller가 초기화 되어야 하나 이전 방식은 그렇게 할 수 없는 방식이였기떄문에
	// Controller들의 모든 의존성 관리를 현 클래스에서 전부 담당하는것으로 함 즉, 각 Panel 및 Frame들은 더이상 Controller 클래스를 가지고있거나
